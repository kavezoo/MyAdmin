<?php
/**
 * President — competitions in country (staff assignment entry).
 *
		...
		<div class="card mb-3 border border-2 shadow">
			<div class="card-header">
				<div class="float-left">
					<h3 class="fw-bold mb-0"><i class="fa fa-id-badge"></i> <?= __('Competition staff') ?></h3>
					<div class="text-muted small"><?= __('Assign check-in and judge staff per competition. Only assigned people may operate those desks on competition day.') ?></div>
				</div>
