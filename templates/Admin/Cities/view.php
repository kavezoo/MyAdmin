		...
		<div class="card mb-3 shadow border border-2">
			...
			<div class="card-body">
				<dl class="record-view-fields mb-0">
					...
					<?php endif; ?>
					<div class="record-view-row"><dt><?= __('Created') ?></dt><dd><?= $city->created ? h(\App\Utility\LocaleDateParser::format($city->created, 'datetime_short')) : '—' ?></dd></div>
					<div class="record-view-row"><dt><?= __('Modified') ?></dt><dd><?= $city->modified ? h(\App\Utility\LocaleDateParser::format($city->modified, 'datetime_short')) : '—' ?></dd></div>
				</dl>
			</div>
