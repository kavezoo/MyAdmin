...
window.MyAdmin.messages = <?= json_encode([
	...
	'unsavedConfirm' => __('You have unsaved changes. Do you really want to leave this form?'),
	'leaveButton' => __('Leave'),
	'stayButton' => __('Stay'),
	'editorResize' => __('Drag to resize the editor'),
	'htmlContent' => __('HTML content'),
	'applyTemplateTitle' => __('Replace description template?'),
	'applyTemplateConfirm' => __('Choosing another template replaces the description text. Any edits you made will be lost.'),
	'applyTemplateReplace' => __('Replace'),
